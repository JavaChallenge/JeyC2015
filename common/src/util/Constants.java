...
public class Constants {
    ...
    public static final String INFO_KEY_MAPSIZE = "mapSize";
    ...
    public static final int CELL_MIN_ENERGY_FOR_MITOSIS = 10;
    public static final int CELL_MAX_ENERGY = 20;
    public static final int CELL_GAIN_RATE = 5;
